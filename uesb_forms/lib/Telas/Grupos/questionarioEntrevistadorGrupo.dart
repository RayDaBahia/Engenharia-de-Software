...
class Questionarioentrevistadorgrupo extends StatefulWidget {
  final String grupoId;

  const Questionarioentrevistadorgrupo({super.key, required this.grupoId});

  @override
  State<Questionarioentrevistadorgrupo> createState() => _QuestionarioentrevistadorgrupoState();
}

class _QuestionarioentrevistadorgrupoState extends State<Questionarioentrevistadorgrupo> {
  String _searchQuery = "";
